...
proto.vega.Node.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    ethereumAdddress: jspb.Message.getFieldWithDefault(msg, 4, ""),
...
/**
 * optional string ethereum_adddress = 4;
 * @return {string}
 */
proto.vega.Node.prototype.getEthereumAdddress = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 4, ""));
};
 ...
 * @return {!proto.vega.Node} returns this
 */
proto.vega.Node.prototype.setEthereumAdddress = function(value) {
  return jspb.Message.setProto3StringField(this, 4, value);
};
...
/**
 * optional string normalised_score = 16;
 * @return {string}
 */
