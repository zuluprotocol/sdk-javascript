...
var vega_api_trading_pb = require('../../vega/api/trading_pb.js');
...
function serialize_api_v1_GetVegaTimeRequest(arg) {
  if (!(arg instanceof vega_api_trading_pb.GetVegaTimeRequest)) {
...
function deserialize_api_v1_GetVegaTimeRequest(buffer_arg) {
  return vega_api_trading_pb.GetVegaTimeRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_api_v1_GetVegaTimeResponse(arg) {
  if (!(arg instanceof vega_api_trading_pb.GetVegaTimeResponse)) {
...
function deserialize_api_v1_GetVegaTimeResponse(buffer_arg) {
  return vega_api_trading_pb.GetVegaTimeResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_api_v1_LastBlockHeightRequest(arg) {
  if (!(arg instanceof vega_api_trading_pb.LastBlockHeightRequest)) {
...
function deserialize_api_v1_LastBlockHeightRequest(buffer_arg) {
  return vega_api_trading_pb.LastBlockHeightRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_api_v1_LastBlockHeightResponse(arg) {
  if (!(arg instanceof vega_api_trading_pb.LastBlockHeightResponse)) {
...
function deserialize_api_v1_LastBlockHeightResponse(buffer_arg) {
  return vega_api_trading_pb.LastBlockHeightResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_api_v1_ObserveEventBusRequest(arg) {
  if (!(arg instanceof vega_api_trading_pb.ObserveEventBusRequest)) {
...
function deserialize_api_v1_ObserveEventBusRequest(buffer_arg) {
  return vega_api_trading_pb.ObserveEventBusRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_api_v1_ObserveEventBusResponse(arg) {
  if (!(arg instanceof vega_api_trading_pb.ObserveEventBusResponse)) {
...
function deserialize_api_v1_ObserveEventBusResponse(buffer_arg) {
  return vega_api_trading_pb.ObserveEventBusResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_api_v1_PropagateChainEventRequest(arg) {
  if (!(arg instanceof vega_api_trading_pb.PropagateChainEventRequest)) {
...
function deserialize_api_v1_PropagateChainEventRequest(buffer_arg) {
  return vega_api_trading_pb.PropagateChainEventRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_api_v1_PropagateChainEventResponse(arg) {
  if (!(arg instanceof vega_api_trading_pb.PropagateChainEventResponse)) {
...
function deserialize_api_v1_PropagateChainEventResponse(buffer_arg) {
  return vega_api_trading_pb.PropagateChainEventResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_api_v1_StatisticsRequest(arg) {
  if (!(arg instanceof vega_api_trading_pb.StatisticsRequest)) {
...
function deserialize_api_v1_StatisticsRequest(buffer_arg) {
  return vega_api_trading_pb.StatisticsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_api_v1_StatisticsResponse(arg) {
  if (!(arg instanceof vega_api_trading_pb.StatisticsResponse)) {
...
function deserialize_api_v1_StatisticsResponse(buffer_arg) {
  return vega_api_trading_pb.StatisticsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_api_v1_SubmitTransactionRequest(arg) {
  if (!(arg instanceof vega_api_trading_pb.SubmitTransactionRequest)) {
    throw new Error('Expected argument of type api.v1.SubmitTransactionRequest');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_api_v1_SubmitTransactionRequest(buffer_arg) {
  return vega_api_trading_pb.SubmitTransactionRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_api_v1_SubmitTransactionResponse(arg) {
  if (!(arg instanceof vega_api_trading_pb.SubmitTransactionResponse)) {
    throw new Error('Expected argument of type api.v1.SubmitTransactionResponse');
  }
  return Buffer.from(arg.serializeBinary());
}

function deserialize_api_v1_SubmitTransactionResponse(buffer_arg) {
  return vega_api_trading_pb.SubmitTransactionResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
submitTransaction: {
    ...
    requestType: vega_api_trading_pb.SubmitTransactionRequest,
    responseType: vega_api_trading_pb.SubmitTransactionResponse,
    requestSerialize: serialize_api_v1_SubmitTransactionRequest,
    requestDeserialize: deserialize_api_v1_SubmitTransactionRequest,
    responseSerialize: serialize_api_v1_SubmitTransactionResponse,
    responseDeserialize: deserialize_api_v1_SubmitTransactionResponse,
  },
...
propagateChainEvent: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: vega_api_trading_pb.PropagateChainEventRequest,
    responseType: vega_api_trading_pb.PropagateChainEventResponse,
...
statistics: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: vega_api_trading_pb.StatisticsRequest,
    responseType: vega_api_trading_pb.StatisticsResponse,
...
lastBlockHeight: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: vega_api_trading_pb.LastBlockHeightRequest,
    responseType: vega_api_trading_pb.LastBlockHeightResponse,
...
getVegaTime: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: vega_api_trading_pb.GetVegaTimeRequest,
    responseType: vega_api_trading_pb.GetVegaTimeResponse,
...
observeEventBus: {
    ...
    requestStream: true,
    responseStream: true,
    requestType: vega_api_trading_pb.ObserveEventBusRequest,
    responseType: vega_api_trading_pb.ObserveEventBusResponse,
