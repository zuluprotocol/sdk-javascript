...
export class Future extends jspb.Message {
    ...
    getOracleSpecForSettlementPrice(): vega_oracles_v1_spec_pb.OracleSpec | undefined;
    setOracleSpecForSettlementPrice(value?: vega_oracles_v1_spec_pb.OracleSpec): Future;

    hasOracleSpecForTradingTermination(): boolean;
    clearOracleSpecForTradingTermination(): void;
    getOracleSpecForTradingTermination(): vega_oracles_v1_spec_pb.OracleSpec | undefined;
    setOracleSpecForTradingTermination(value?: vega_oracles_v1_spec_pb.OracleSpec): Future;
...
export namespace Future {
    export type AsObject = {
        ...
        quoteName: string,
        oracleSpecForSettlementPrice?: vega_oracles_v1_spec_pb.OracleSpec.AsObject,
        oracleSpecForTradingTermination?: vega_oracles_v1_spec_pb.OracleSpec.AsObject,
