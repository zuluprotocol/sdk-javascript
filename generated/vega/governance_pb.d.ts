...
export class FutureProduct extends jspb.Message {
    ...
    getOracleSpecForSettlementPrice(): vega_oracles_v1_spec_pb.OracleSpecConfiguration | undefined;
    setOracleSpecForSettlementPrice(value?: vega_oracles_v1_spec_pb.OracleSpecConfiguration): FutureProduct;

    hasOracleSpecForTradingTermination(): boolean;
    clearOracleSpecForTradingTermination(): void;
    getOracleSpecForTradingTermination(): vega_oracles_v1_spec_pb.OracleSpecConfiguration | undefined;
    setOracleSpecForTradingTermination(value?: vega_oracles_v1_spec_pb.OracleSpecConfiguration): FutureProduct;

    hasOracleSpecBinding(): boolean;
    clearOracleSpecBinding(): void;
    getOracleSpecBinding(): vega_markets_pb.OracleSpecToFutureBinding | undefined;
    setOracleSpecBinding(value?: vega_markets_pb.OracleSpecToFutureBinding): FutureProduct;
...
export namespace FutureProduct {
    export type AsObject = {
        ...
        quoteName: string,
        oracleSpecForSettlementPrice?: vega_oracles_v1_spec_pb.OracleSpecConfiguration.AsObject,
        oracleSpecForTradingTermination?: vega_oracles_v1_spec_pb.OracleSpecConfiguration.AsObject,
        oracleSpecBinding?: vega_markets_pb.OracleSpecToFutureBinding.AsObject,
    }
}
...
export class NewMarketConfiguration extends jspb.Message {
    ...
    getPriceMonitoringParameters(): vega_markets_pb.PriceMonitoringParameters | undefined;
    setPriceMonitoringParameters(value?: vega_markets_pb.PriceMonitoringParameters): NewMarketConfiguration;

    hasLiquidityMonitoringParameters(): boolean;
    clearLiquidityMonitoringParameters(): void;
    getLiquidityMonitoringParameters(): vega_markets_pb.LiquidityMonitoringParameters | undefined;
    setLiquidityMonitoringParameters(value?: vega_markets_pb.LiquidityMonitoringParameters): NewMarketConfiguration;

    hasSimple(): boolean;
    clearSimple(): void;
    getSimple(): vega_markets_pb.SimpleModelParams | undefined;
    setSimple(value?: vega_markets_pb.SimpleModelParams): NewMarketConfiguration;

    hasLogNormal(): boolean;
    clearLogNormal(): void;
    getLogNormal(): vega_markets_pb.LogNormalRiskModel | undefined;
    setLogNormal(value?: vega_markets_pb.LogNormalRiskModel): NewMarketConfiguration;

    hasContinuous(): boolean;
    clearContinuous(): void;
    getContinuous(): vega_markets_pb.ContinuousTrading | undefined;
    setContinuous(value?: vega_markets_pb.ContinuousTrading): NewMarketConfiguration;

    hasDiscrete(): boolean;
    clearDiscrete(): void;
    getDiscrete(): vega_markets_pb.DiscreteTrading | undefined;
    setDiscrete(value?: vega_markets_pb.DiscreteTrading): NewMarketConfiguration;
...
export namespace NewMarketConfiguration {
    export type AsObject = {
        ...
        priceMonitoringParameters?: vega_markets_pb.PriceMonitoringParameters.AsObject,
        liquidityMonitoringParameters?: vega_markets_pb.LiquidityMonitoringParameters.AsObject,
        simple?: vega_markets_pb.SimpleModelParams.AsObject,
        logNormal?: vega_markets_pb.LogNormalRiskModel.AsObject,
        continuous?: vega_markets_pb.ContinuousTrading.AsObject,
        discrete?: vega_markets_pb.DiscreteTrading.AsObject,
    }
...
export class NewMarketCommitment extends jspb.Message {
    ...
    clearSellsList(): void;
    getSellsList(): Array<vega_vega_pb.LiquidityOrder>;
    setSellsList(value: Array<vega_vega_pb.LiquidityOrder>): NewMarketCommitment;
    addSells(value?: vega_vega_pb.LiquidityOrder, index?: number): vega_vega_pb.LiquidityOrder;
    clearBuysList(): void;
    getBuysList(): Array<vega_vega_pb.LiquidityOrder>;
    setBuysList(value: Array<vega_vega_pb.LiquidityOrder>): NewMarketCommitment;
    addBuys(value?: vega_vega_pb.LiquidityOrder, index?: number): vega_vega_pb.LiquidityOrder;
    getReference(): string;
...
export namespace NewMarketCommitment {
    export type AsObject = {
        ...
        fee: string,
        sellsList: Array<vega_vega_pb.LiquidityOrder.AsObject>,
        buysList: Array<vega_vega_pb.LiquidityOrder.AsObject>,
        reference: string,
    }
}
...
export class UpdateNetworkParameter extends jspb.Message {
    ...
    hasChanges(): boolean;
    clearChanges(): void;
    getChanges(): vega_vega_pb.NetworkParameter | undefined;
    setChanges(value?: vega_vega_pb.NetworkParameter): UpdateNetworkParameter;
...
export namespace UpdateNetworkParameter {
    export type AsObject = {
        changes?: vega_vega_pb.NetworkParameter.AsObject,
    }
}
...
export class NewAsset extends jspb.Message {
    ...
    hasChanges(): boolean;
    clearChanges(): void;
    getChanges(): vega_assets_pb.AssetDetails | undefined;
    setChanges(value?: vega_assets_pb.AssetDetails): NewAsset;
...
export namespace NewAsset {
    export type AsObject = {
        changes?: vega_assets_pb.AssetDetails.AsObject,
    }
}
