...
export class MarketData extends jspb.Message {
    ...
    getMarketTradingMode(): vega_markets_pb.Market.TradingMode;
    setMarketTradingMode(value: vega_markets_pb.Market.TradingMode): MarketData;
...
export namespace MarketData {
    export type AsObject = {
        ...
        indicativePrice: string,
        indicativeVolume: number,
        marketTradingMode: vega_markets_pb.Market.TradingMode,
...
export class PriceMonitoringBounds extends jspb.Message {
    ...
    setTrigger(value?: vega_markets_pb.PriceMonitoringTrigger): PriceMonitoringBounds;
...
export class EpochTimestamps extends jspb.Message {
    ...
    setExpiryTime(value: number): EpochTimestamps;
    getEndTime(): number;
...
export class Node extends jspb.Message {
    ...
    getTmPubKey(): string;
    setTmPubKey(value: string): Node;
    getEthereumAdddress(): string;
    setEthereumAdddress(value: string): Node;
    getInfoUrl(): string;
    ...
    clearDelegationsList(): void;
    getDelegationsList(): Array<Delegation>;
    setDelegationsList(value: Array<Delegation>): Node;
    addDelegations(value?: Delegation, index?: number): Delegation;
    getScore(): string;
