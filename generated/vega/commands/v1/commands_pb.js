...
proto.vega.commands.v1.OrderAmendment.toObject = function(includeInstance, msg) {
  var f, obj = {
    orderId: jspb.Message.getFieldWithDefault(msg, 1, ""),
    marketId: jspb.Message.getFieldWithDefault(msg, 2, ""),
    price: (f = msg.getPrice()) && vega_vega_pb.Price.toObject(includeInstance, f),
    sizeDelta: jspb.Message.getFieldWithDefault(msg, 4, 0),
    expiresAt: (f = msg.getExpiresAt()) && vega_vega_pb.Timestamp.toObject(includeInstance, f),
...
proto.vega.commands.v1.OrderAmendment.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new vega_vega_pb.Price;
      reader.readMessage(value,vega_vega_pb.Price.deserializeBinaryFromReader);
      msg.setPrice(value);
      break;
    case 4:
      var value = /** @type {number} */ (reader.readInt64());
      ...
      break;
    case 5:
      var value = new vega_vega_pb.Timestamp;
      reader.readMessage(value,vega_vega_pb.Timestamp.deserializeBinaryFromReader);
      msg.setExpiresAt(value);
      break;
    case 6:
      var value = /** @type {!proto.vega.Order.TimeInForce} */ (reader.readEnum());
...
proto.vega.commands.v1.OrderAmendment.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      vega_vega_pb.Price.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      5,
      f,
      vega_vega_pb.Timestamp.serializeBinaryToWriter
    );
  }
  f = message.getTimeInForce();
  if (f !== 0.0) {
...
proto.vega.commands.v1.OrderAmendment.prototype.getPrice = function() {
  return /** @type{?proto.vega.Price} */ (
    jspb.Message.getWrapperField(this, vega_vega_pb.Price, 3));
};
...
proto.vega.commands.v1.OrderAmendment.prototype.getExpiresAt = function() {
  return /** @type{?proto.vega.Timestamp} */ (
    jspb.Message.getWrapperField(this, vega_vega_pb.Timestamp, 5));
};
