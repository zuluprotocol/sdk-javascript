...
// file: vega/commands/v1/commands.proto
...
export class OrderSubmission extends jspb.Message {
    ...
    getSide(): vega_vega_pb.Side;
    setSide(value: vega_vega_pb.Side): OrderSubmission;
    getTimeInForce(): vega_vega_pb.Order.TimeInForce;
    setTimeInForce(value: vega_vega_pb.Order.TimeInForce): OrderSubmission;
    getExpiresAt(): number;
    setExpiresAt(value: number): OrderSubmission;
    getType(): vega_vega_pb.Order.Type;
    setType(value: vega_vega_pb.Order.Type): OrderSubmission;
    getReference(): string;
    setReference(value: string): OrderSubmission;

    hasPeggedOrder(): boolean;
    clearPeggedOrder(): void;
    getPeggedOrder(): vega_vega_pb.PeggedOrder | undefined;
    setPeggedOrder(value?: vega_vega_pb.PeggedOrder): OrderSubmission;
...
export namespace OrderSubmission {
    export type AsObject = {
        ...
        price: string,
        size: number,
        side: vega_vega_pb.Side,
        timeInForce: vega_vega_pb.Order.TimeInForce,
        expiresAt: number,
        type: vega_vega_pb.Order.Type,
        reference: string,
        peggedOrder?: vega_vega_pb.PeggedOrder.AsObject,
    }
}
...
export class OrderAmendment extends jspb.Message {
    ...
    hasPrice(): boolean;
    clearPrice(): void;
    getPrice(): vega_vega_pb.Price | undefined;
    setPrice(value?: vega_vega_pb.Price): OrderAmendment;
    getSizeDelta(): number;
    setSizeDelta(value: number): OrderAmendment;

    hasExpiresAt(): boolean;
    clearExpiresAt(): void;
    getExpiresAt(): vega_vega_pb.Timestamp | undefined;
    setExpiresAt(value?: vega_vega_pb.Timestamp): OrderAmendment;
    getTimeInForce(): vega_vega_pb.Order.TimeInForce;
    setTimeInForce(value: vega_vega_pb.Order.TimeInForce): OrderAmendment;
    ...
    getPeggedReference(): vega_vega_pb.PeggedReference;
    setPeggedReference(value: vega_vega_pb.PeggedReference): OrderAmendment;
...
export namespace OrderAmendment {
    export type AsObject = {
        orderId: string,
        marketId: string,
        price?: vega_vega_pb.Price.AsObject,
        sizeDelta: number,
        expiresAt?: vega_vega_pb.Timestamp.AsObject,
        timeInForce: vega_vega_pb.Order.TimeInForce,
        peggedOffset?: google_protobuf_wrappers_pb.Int64Value.AsObject,
        peggedReference: vega_vega_pb.PeggedReference,
    }
}
...
export class LiquidityProvisionSubmission extends jspb.Message {
    ...
    setSellsList(value: Array<vega_vega_pb.LiquidityOrder>): LiquidityProvisionSubmission;
    ...
    setBuysList(value: Array<vega_vega_pb.LiquidityOrder>): LiquidityProvisionSubmission;
...
export class WithdrawSubmission extends jspb.Message {
    ...
    hasExt(): boolean;
    clearExt(): void;
    getExt(): vega_vega_pb.WithdrawExt | undefined;
    setExt(value?: vega_vega_pb.WithdrawExt): WithdrawSubmission;
...
export namespace WithdrawSubmission {
    export type AsObject = {
        amount: string,
        asset: string,
        ext?: vega_vega_pb.WithdrawExt.AsObject,
    }
}
...
export class ProposalSubmission extends jspb.Message {
    ...
    hasTerms(): boolean;
    clearTerms(): void;
    getTerms(): vega_governance_pb.ProposalTerms | undefined;
    setTerms(value?: vega_governance_pb.ProposalTerms): ProposalSubmission;
...
export namespace ProposalSubmission {
    export type AsObject = {
        reference: string,
        terms?: vega_governance_pb.ProposalTerms.AsObject,
    }
}
...
export class VoteSubmission extends jspb.Message {
    ...
    getValue(): vega_governance_pb.Vote.Value;
    setValue(value: vega_governance_pb.Vote.Value): VoteSubmission;
...
export namespace VoteSubmission {
    export type AsObject = {
        proposalId: string,
        value: vega_governance_pb.Vote.Value,
    }
}
