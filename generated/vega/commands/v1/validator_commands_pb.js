 ...
 * @return {number}
 */
proto.vega.commands.v1.NodeRegistration.prototype.getVegaPubKeyIndex = function() {
 ...
 * @return {!proto.vega.commands.v1.NodeRegistration} returns this
 */
proto.vega.commands.v1.NodeRegistration.prototype.setVegaPubKeyIndex = function(value) {
...
proto.vega.commands.v1.ChainEvent.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    btc: (f = msg.getBtc()) && vega_chain_events_pb.BTCEvent.toObject(includeInstance, f),
    validator: (f = msg.getValidator()) && vega_chain_events_pb.ValidatorEvent.toObject(includeInstance, f),
...
proto.vega.commands.v1.ChainEvent.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1002:
      ...
      break;
    case 1003:
      var value = new vega_chain_events_pb.BTCEvent;
      reader.readMessage(value,vega_chain_events_pb.BTCEvent.deserializeBinaryFromReader);
      msg.setBtc(value);
      break;
    case 1004:
      var value = new vega_chain_events_pb.ValidatorEvent;
      reader.readMessage(value,vega_chain_events_pb.ValidatorEvent.deserializeBinaryFromReader);
...
proto.vega.commands.v1.ChainEvent.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1003,
      f,
      vega_chain_events_pb.BTCEvent.serializeBinaryToWriter
    );
  }
  ...
  if (f != null) {
    writer.writeMessage(
      1004,
      f,
      vega_chain_events_pb.ValidatorEvent.serializeBinaryToWriter
    );
  }
...
proto.vega.commands.v1.ChainEvent.prototype.getBtc = function() {
  return /** @type{?proto.vega.BTCEvent} */ (
    jspb.Message.getWrapperField(this, vega_chain_events_pb.BTCEvent, 1003));
};
...
proto.vega.commands.v1.ChainEvent.prototype.getValidator = function() {
  return /** @type{?proto.vega.ValidatorEvent} */ (
    jspb.Message.getWrapperField(this, vega_chain_events_pb.ValidatorEvent, 1004));
};
